...
from nnunetv2.nets.AortaNet.AortaV1 import Aorta1#增加了输出层

class nnUNetTrainerSNet1(nnUNetTrainer):
    @staticmethod
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = Aorta1(in_channels=num_input_channels,n_channels=32,
