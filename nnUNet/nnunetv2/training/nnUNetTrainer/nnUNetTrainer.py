...
from nnunetv2.inference.predict_from_raw_data_t import nnUNetPredictor
...
class nnUNetTrainer(object):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        # 重新训练的n_classes=4，
        # model = Aorta2(in_channels=1,n_channels=32,
        #     n_classes=4,exp_r=[2,3,4,4,4,4,4,3,2],#[2,3,4,4,4,4,4,3,2] [1,2,3,3,3,3,3,2,1]
        #     kernel_size=3,deep_supervision=True,do_res=True,
