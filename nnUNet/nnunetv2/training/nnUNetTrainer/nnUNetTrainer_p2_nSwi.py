...
from .AortaNet.AortaV1 import Aorta1#增加了输出层
from monai.transforms import AsDiscrete
from .nSwinunetr.nSwinunetr import nSwinUNETR
...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        self.enable_deep_supervision = False #True False
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = nSwinUNETR(img_size=patch_size,
            in_channels=1,out_channels=4,
            feature_size=48,drop_rate=0.0,
            attn_drop_rate=0.0,dropout_path_rate=0.0,
            use_checkpoint=True,deep_supervision=False,)#SwinUNETR本身为无深度监督，这里修改后可以选择深度监督
        return model
