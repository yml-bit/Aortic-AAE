...
class Inference():
    ...
    def predict_1a(self, input_dir, output_dir):
        f = open("/media/bit301/data/yml/project/python39/p2/process/list/t_test_list.txt")  # hnnk test.txt
        output_file = "/media/bit301/data/yml/project/python39/p2/process/list/t_test_results.txt"
        path_list = []
        ij = 0
